...
const EN = {
	...
	shortcut: { gallery: "Arrow keys move · Space selects · Enter previews · Esc cancels", preview: "←/→ switch · Space selects · +/- zoom · 0 resets · Esc returns" },
	aria: { modal: "Image selection dialog", gallery: "Images available for selection", countdown: "Time remaining: {time}. On timeout: {action}.", image: "Image {number}", selectedImage: "Image {number}, selected", instructions: "Markdown instructions", preview: "Large image preview", live: "Image picker status" },
